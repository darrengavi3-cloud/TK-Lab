...
const codeInputs=['domain/catalogue.ts','domain/revisions.ts','domain/publication.ts','server/catalogue-service.ts','server/import-service.ts','server/publication-service.ts','server/admin-router.ts'];
