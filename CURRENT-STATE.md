...
第二次交付已實作一份任官修訂同步到人物履歷、明確選定的官職任職者及州鎮條目，正在完成發布驗證。部署成功前，線上仍按下表的第 44 版記錄。資料權威與遷移邊界見[任官閱讀關聯](docs/catalogue-reader-links.md)；不提升 V86／R1，也不改寫第 43／44 版歷史回執。

## 觀史台當前產品與部署

| 維度 | 當前值（2026-09-17 核對） | 邊界 |
| --- | --- | --- |
| 產品 | 管理後台一期：人物、任官、引用史料 | 編輯、匯入、修訂、預覽及統一發布已接通；全部領域重構尚未完成 |
| Sites 程式部署 | **第 44 版，succeeded，2026-09-17 14:47:14 UTC** | [獨立部署回執](release-metadata/catalogue-deployment.json)；保留第 43 版 R1 歷史 |
| 實際部署源碼 | `8c117b47edf571a7a23b90075630201626d4b04a` | 與 GitHub 實作提交 `c7f06f7b3e8d95d6ae9d0f8eee4e78ebfb81682b` 的 tree 完全一致 |
