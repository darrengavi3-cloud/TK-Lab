...
V71 续修恢复六条早期已核、但未接入最终投影的金石释文，再据古籍补入吕君、刘镇南、王基、洛阳北界四条录文，当前为 54 条有释文、112 条缺文。异文与著录也进入读者详情和手机抽屉。当前 101 条任官通过发布审定，旧批次人物身份待核已收口，48 条保留在审校层。V62 的 2096 人基线保持不变，V71 有据增补三人，读者合计 2099 人；刘沈保留 ID 并核定为西晋。
