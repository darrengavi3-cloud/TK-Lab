...
V71 续修恢复六条早期已核、但未接入最终投影的金石释文，再据古籍补入吕君、刘镇南、王基、洛阳北界、大飨碑、修老子庙诏六条录文，该批完成后为 56 条有释文、110 条缺文。异文与著录也进入读者详情和手机抽屉。当前 101 条任官通过发布审定，旧批次人物身份待核已收口，48 条保留在审校层。V62 的 2096 人基线保持不变，V71 有据增补三人，读者合计 2099 人；刘沈保留 ID 并核定为西晋。
...
V72 续核补入《全晋文》所辑郑袤碑、杨肇碑、刘韬墓志三条存文，当前 59 条有文、107 条缺文；杨肇碑别本全文独立保留。修正旧解析器泰始元年起点 266→265，并以逐条源摘要更正读者中的七条纪年。此为纪年标年换算，不是具体农历日期换算；底本年号、已有正文和人物资料不改动。
