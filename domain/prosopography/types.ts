...
export interface OfficeTenure extends ResearchStatus {
  ...
  officeVersion: RevisionPin | null;
...
export interface CareerEvent {
  ...
  /** An explicit relative chronology; absent dates must not be fabricated. */
...
export interface PresenceResult {tenureId: string; year: number; status: Presence; definite: boolean; claimIds: string[]; reason: string}
