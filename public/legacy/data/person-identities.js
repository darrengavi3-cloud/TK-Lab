(function(global){
  ...
  const identities=[
    ...
    {personId:'person:wei:cao-man',name:'曹曼',aliases:['公女曼'],polities:['魏'],searchKeys:['caoman']},
    {personId:'person:han:cao-ding',name:'曹鼎',aliases:['伯父鼎'],polities:['汉'],searchKeys:['caoding']},
    {personId:'person:wu:shi-kuang',name:'士匡',aliases:['匡师友'],polities:['吴'],searchKeys:['shikuang']},
    {personId:'person:han:zhang-lu',name:'张鲁',aliases:['張魯','鲁镇南'],polities:['汉'],searchKeys:['zhanglu']},
    {personId:'person:han:dong-min',name:'董旻',aliases:['卓弟旻'],polities:['汉'],searchKeys:['dongmin']},
