...
assert((reader.people||[]).filter(person=>person.bio).length===94,'读者人物小传数量异常');
...
if(failures.length){
  ...
  console.log(JSON.stringify({ok:true,biographies:94,fangzhen:{records:45,levels:{州:36,方镇:9},dynasties:{后汉:5,季汉:6}},removedRelatedOfficials:true},null,2));
}
