...
assert(epigraphyInscribed === 50 && epigraphyRecords.length - epigraphyInscribed === 116, `V69 金石读者投影应为 50 有释文 / 116 空释文，实际 ${epigraphyInscribed}/${epigraphyRecords.length - epigraphyInscribed}`);
