...
(function(global){
  ...
  const records = [
    ...
    row('wei_213_cao_pi',sourceWeiDuke213,'魏','建安十八年·魏公国','曹丕','五官中郎将',{rawRole:'五官中郎将（丞相副）',roleRelation:'丞相副',startYear:211,endYear:220,confidence:'确定',sourceExcerpt:'《三国志·武帝纪》载曹丕为五官中郎将，官属为丞相副。'}),
    ...
    row('han_220_cao_cao',sourceHanEnd220,'汉','延康元年·曹丕践祚前','曹操','丞相',{rawRole:'丞相（薨）',tenureEndReason:'薨',startYear:220,endYear:220,confidence:'确定',sourceExcerpt:'《三国志·文帝纪》以曹操薨后曹丕承继政治权力，旋即受汉禅。'}),
    ...
    row('shu_end_jiangwei',sourceShu,'汉','蜀亡前夕','姜维','大将军',{rawRole:'大将军、录尚书事',recordGroupId:'shu_end_jiangwei_offices',startYear:263,endYear:263}),
    row('shu_end_jiangwei_lu_shangshu',sourceShu,'汉','蜀亡前夕','姜维','录尚书事',{rawRole:'大将军、录尚书事',recordGroupId:'shu_end_jiangwei_offices',appointmentNature:'兼领',startYear:263,endYear:263}),
    ...
    row('shu_end_dongjue',sourceShu,'汉','蜀亡前夕','董厥','辅国大将军',{rawRole:'辅国大将军、录尚书事',recordGroupId:'shu_end_dongjue_offices',startYear:263,endYear:263}),
    row('shu_end_dongjue_lu_shangshu',sourceShu,'汉','蜀亡前夕','董厥','录尚书事',{rawRole:'辅国大将军、录尚书事',recordGroupId:'shu_end_dongjue_offices',appointmentNature:'兼领',startYear:263,endYear:263}),
