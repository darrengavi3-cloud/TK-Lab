...
const Commanderies = (function () {
  ...
  function makePolygon(feature) {
    ...
    const color = MapSafeHtml.safeHex(feature.color || factionColor(feature.kingdom),'#5c5348');
  ...
  function render(map, data, opts) {
    ...
    data.forEach((feature) => {
      ...
      poly.bindTooltip(MapSafeHtml.escapeHtml(tip), { sticky: true, className: 'tt-cmd' });
      poly.on('click', () => {
