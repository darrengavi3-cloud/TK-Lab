(function registerPersistenceCore(global){
   ...
   */
  function createPatchEngine(adapters={}){
  ...
  global.SGZ_UI_MODULES.persistence=Object.freeze({createDirtyState,createPatchEngine});
})(window);
